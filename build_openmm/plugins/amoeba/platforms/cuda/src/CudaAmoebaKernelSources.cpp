...
const string CudaAmoebaKernelSources::amoebaAngleForce = "float2 angleParams = PARAMS[index];\n"
...
"dEdAngle *= RAD_TO_DEG;";
const string CudaAmoebaKernelSources::amoebaBondForce = "float2 bondParams = PARAMS[index];\n"
...
"";
const string CudaAmoebaKernelSources::amoebaGk = "#define TILE_SIZE 32\n"
"\n"
"/**\n"
...
"}\n"
"";
const string CudaAmoebaKernelSources::amoebaInPlaneForce = "float2 angleParams = PARAMS[index];\n"
...
"";
const string CudaAmoebaKernelSources::amoebaOutOfPlaneBendForce = "// compute the value of the bond angle\n"
"\n"
...
"";
const string CudaAmoebaKernelSources::amoebaPiTorsionForce = "// compute the value of the pi-orbital torsion angle\n"
"\n"
"real3 ad = make_real3(pos1.x-pos4.x, pos1.y-pos4.y, pos1.z-pos4.z);\n"
"real3 bd = make_real3(pos2.x-pos4.x, pos2.y-pos4.y, pos2.z-pos4.z);\n"
...
const string CudaAmoebaKernelSources::amoebaStretchBendForce = "// compute the value of the bond angle\n"
"\n"
"real3 ab = make_real3(pos1.x-pos2.x, pos1.y-pos2.y, pos1.z-pos2.z);\n"
"real3 cb = make_real3(pos3.x-pos2.x, pos3.y-pos2.y, pos3.z-pos2.z);\n"
"\n"
...
"";
const string CudaAmoebaKernelSources::amoebaTorsionTorsionForce = "int2 torsionParams = TORSION_PARAMS[index];\n"
"\n"
...
const string CudaAmoebaKernelSources::amoebaVdwForce1 = "/**\n"
...
"}\n"
"";
const string CudaAmoebaKernelSources::amoebaVdwForce2 = "{\n"
"#ifdef USE_CUTOFF\n"
...
"}\n"
"";
const string CudaAmoebaKernelSources::amoebaWcaForce = "#define TILE_SIZE 32\n"
...
"}\n"
"";
const string CudaAmoebaKernelSources::bicubic = "__device__ void bicubic(real4 y, real4 y1i, real4 y2i, real4 y12i, real x1, real x1l, real x1u,\n"
...
"    *dang2Out = dang2;\n"
"}";
const string CudaAmoebaKernelSources::gkEDiffPairForce = "#if defined F1\n"
"__device__ void computeOneEDiffInteractionF1(AtomData4& atom1, volatile AtomData4& atom2, float dScale, float pScale, real& outputEnergy, real3& outputForce) {\n"
"#elif defined T1\n"
"__device__ void computeOneEDiffInteractionT1(AtomData4& atom1, volatile AtomData4& atom2, float dScale, float pScale, real3& outputForce) {\n"
"#elif defined T3\n"
...
"}\n"
"";
const string CudaAmoebaKernelSources::gkPairForce1 = "/**\n"
...
"#endif\n"
"";
const string CudaAmoebaKernelSources::gkPairForce2 = "\n"
"#if defined F1 || defined F2 || defined T1\n"
...
"}\n"
"";
const string CudaAmoebaKernelSources::multipoleElectrostatics = "#define WARPS_PER_GROUP (THREAD_BLOCK_SIZE/TILE_SIZE)\n"
"\n"
"typedef struct {\n"
...
"}\n"
"";
const string CudaAmoebaKernelSources::multipoleFixedField = "#define WARPS_PER_GROUP (THREAD_BLOCK_SIZE/TILE_SIZE)\n"
"\n"
"typedef struct {\n"
"    real4 posq;\n"
...
"}\n"
"";
const string CudaAmoebaKernelSources::multipoleInducedField = "#define WARPS_PER_GROUP (THREAD_BLOCK_SIZE/TILE_SIZE)\n"
"\n"
"typedef struct {\n"
"    real3 pos;\n"
...
"}\n"
"";
const string CudaAmoebaKernelSources::multipoles = "extern \"C\" __global__ void computeLabFrameMoments(real4* __restrict__ posq, int4* __restrict__ multipoleParticles, float* __restrict__ molecularDipoles,\n"
...
"}\n"
"";
const string CudaAmoebaKernelSources::pmeMultipoleElectrostatics = "#define WARPS_PER_GROUP (THREAD_BLOCK_SIZE/TILE_SIZE)\n"
"\n"
"typedef struct {\n"
"    real3 pos, force, torque, inducedDipole, inducedDipolePolar, sphericalDipole;\n"
"    real q;\n"
...
"}\n"
"";
const string CudaAmoebaKernelSources::sphericalMultipoles = "__device__ void buildQIRotationMatrix(real3 deltaR, real rInv, real (&rotationMatrix)[3][3]) {\n"
