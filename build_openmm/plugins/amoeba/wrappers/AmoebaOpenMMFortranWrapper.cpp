...
OPENMM_EXPORT_AMOEBA void openmm_amoebavdwforce_setparticleparameters_(OpenMM_AmoebaVdwForce*& target, int const& particleIndex, int const& parentIndex, double const& sigma, double const& epsilon, double const& reductionFactor) {
    OpenMM_AmoebaVdwForce_setParticleParameters(target, particleIndex, parentIndex, sigma, epsilon, reductionFactor);
}
OPENMM_EXPORT_AMOEBA void OPENMM_AMOEBAVDWFORCE_SETPARTICLEPARAMETERS(OpenMM_AmoebaVdwForce*& target, int const& particleIndex, int const& parentIndex, double const& sigma, double const& epsilon, double const& reductionFactor) {
    OpenMM_AmoebaVdwForce_setParticleParameters(target, particleIndex, parentIndex, sigma, epsilon, reductionFactor);
}
OPENMM_EXPORT_AMOEBA void openmm_amoebavdwforce_getparticleparameters_(const OpenMM_AmoebaVdwForce*& target, int const& particleIndex, int* parentIndex, double* sigma, double* epsilon, double* reductionFactor) {
    OpenMM_AmoebaVdwForce_getParticleParameters(target, particleIndex, parentIndex, sigma, epsilon, reductionFactor);
}
OPENMM_EXPORT_AMOEBA void OPENMM_AMOEBAVDWFORCE_GETPARTICLEPARAMETERS(const OpenMM_AmoebaVdwForce*& target, int const& particleIndex, int* parentIndex, double* sigma, double* epsilon, double* reductionFactor) {
    OpenMM_AmoebaVdwForce_getParticleParameters(target, particleIndex, parentIndex, sigma, epsilon, reductionFactor);
}
OPENMM_EXPORT_AMOEBA int openmm_amoebavdwforce_addparticle_(OpenMM_AmoebaVdwForce*& target, int const& parentIndex, double const& sigma, double const& epsilon, double const& reductionFactor) {
    return OpenMM_AmoebaVdwForce_addParticle(target, parentIndex, sigma, epsilon, reductionFactor);
}
OPENMM_EXPORT_AMOEBA int OPENMM_AMOEBAVDWFORCE_ADDPARTICLE(OpenMM_AmoebaVdwForce*& target, int const& parentIndex, double const& sigma, double const& epsilon, double const& reductionFactor) {
    return OpenMM_AmoebaVdwForce_addParticle(target, parentIndex, sigma, epsilon, reductionFactor);
}
